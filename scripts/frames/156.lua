...
function onInstanceInit( frame, instance )
   ...
   instance:setStatPerm( "Constitution", 14 )
   instance:setStatPerm( "Wisdom", 14 )
   instance:setStatPerm( "Charisma", 14 )
   instance:setStatPerm( "Health", 250 )
   instance:setStatMod( "Health", 250 )
   ...
   instance:setStatPerm( "PowerLevel", 150 )
