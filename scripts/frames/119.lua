...
function onInstanceInit( frame, instance )
   ...
   instance:setStatPerm( "Mana_Regen", 212 )
   instance:setStatPerm( "HP_Regen", 40 )
   ...
   instance:setStatPerm( "Stamina", 120 )
   instance:setStatMod( "Stamina", 120 )
   instance:setStatPerm( "Spirit", 12 )
   instance:setStatMod( "Spirit", 12 )
   instance:setStatPerm( "Energy", 700 )
   instance:setStatMod( "Energy", 700 )
   instance:setStatPerm( "Accuracy", 13 )
   instance:setStatPerm( "Evasiveness", 13 )
   instance:setStatPerm( "Luck", 15 )
   instance:setStatPerm( "Health", 60 )
   instance:setStatMod( "Health", 60 )
   instance:setStatPerm( "Charisma", 15 )
   instance:setStatPerm( "Wisdom", 18 )
   instance:setStatPerm( "Constitution", 20 )
   instance:setStatPerm( "Intelligence", 18 )
   instance:setStatPerm( "Dexterity", 14 )
   instance:setStatPerm( "Strength", 14 )
   --- end autowrite init ---
end
