...
function onInstanceInit( frame, instance )
   ...
   --- autowrite init ---
   instance:setStatPerm( "Strength", 10 )
   instance:setStatPerm( "Dexterity", 10 )
   instance:setStatPerm( "Intelligence", 10 )
   instance:setStatPerm( "Constitution", 10 )
   instance:setStatPerm( "Wisdom", 10 )
   instance:setStatPerm( "Charisma", 10 )
   instance:setStatPerm( "Health", 150 )
   instance:setStatMod( "Health", 150 )
   instance:setStatPerm( "Luck", 10 )
   ...
   instance:setStatPerm( "PowerLevel", 25 )
   instance:setStatPerm( "Damroll", 2 )
   instance:setStatPerm( "Hitroll", 2 )
   instance:setStatPerm( "Experience", 1 )
   instance:setStatPerm( "HP_Regen", 25 )
   instance:setStatPerm( "Mana_Regen", 40 )
   instance:setStatPerm( "Stamina_Regen", 20 )
