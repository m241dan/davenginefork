...
function onInstanceInit( frame, instance )
   ...
   --- autowrite init ---
   instance:setStatPerm( "Stamina_Regen", 33 )
   instance:setStatPerm( "Mana_Regen", 144 )
   instance:setStatPerm( "HP_Regen", 28 )
   ...
   instance:setStatPerm( "Stamina", 86 )
   instance:setStatMod( "Stamina", 86 )
   instance:setStatPerm( "Spirit", 10 )
   instance:setStatMod( "Spirit", 10 )
   instance:setStatPerm( "Energy", 460 )
   instance:setStatMod( "Energy", 460 )
   instance:setStatPerm( "Accuracy", 15 )
   instance:setStatPerm( "Evasiveness", 15 )
   instance:setStatPerm( "Luck", 20 )
   instance:setStatPerm( "Health", 43 )
   instance:setStatMod( "Health", 43 )
   instance:setStatPerm( "Charisma", 15 )
   instance:setStatPerm( "Wisdom", 13 )
   instance:setStatPerm( "Constitution", 13 )
   instance:setStatPerm( "Intelligence", 13 )
   instance:setStatPerm( "Dexterity", 13 )
   instance:setStatPerm( "Strength", 13 )
   --- end autowrite init ---
end
