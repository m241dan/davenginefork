...
function onInstanceInit( frame, instance )
   ...
   --- autowrite init ---
   instance:setStatPerm( "Strength", 12 )
   instance:setStatPerm( "Dexterity", 12 )
   instance:setStatPerm( "Intelligence", 12 )
   instance:setStatPerm( "Constitution", 12 )
   instance:setStatPerm( "Wisdom", 12 )
   instance:setStatPerm( "Charisma", 12 )
   instance:setStatPerm( "Health", 200 )
   instance:setStatMod( "Health", 200 )
   instance:setStatPerm( "Luck", 12 )
   ...
   instance:setStatPerm( "PowerLevel", 75 )
