...
function uiInventory( entity )
   local str, dex, con, int, wis, chr, lck = attacker:getStatPerm( "Strength" ), attacker:getStatPerm( "Dexterity" ), attacker:getStatPerm( "Constitution" ), attacker:getStatPerm( "Intelligence" ), attacker:getStatPerm( "Wisdom" ), attacker:getStatPerm( "Charisma" ), attacker:getStatPerm( "Luck" )
   local total = str + dex + con + int + wis + chr + lck
end
