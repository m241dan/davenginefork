...
typedef enum
{
   STATE_NANNY, STATE_ACCOUNT, STATE_OLC, STATE_EFRAME_EDITOR, STATE_EINSTANCE_EDITOR, STATE_WORKSPACE_EDITOR, STATE_PROJECT_EDITOR, STATE_BUILDER, STATE_PLAYING, STATE_CLOSED, MAX_STATE
} socket_states;
...
{
   /* IS Specs */
   SPEC_ISROOM, SPEC_ISEXIT, SPEC_ISMOB, SPEC_ISOBJECT, SPEC_ISDOOR,
   /* Can Specs */
